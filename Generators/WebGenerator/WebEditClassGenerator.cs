...
namespace voidsoft
{
	public partial class WebClassGenerator
	{
		...
		//public string GenerateWebEditMarkup(EntityDefinition e)
		//{
		//	var b = new StringBuilder();

		//	b.Append("<%@ Page Language='C#' MasterPageFile='~/MasterPages/Admin.Master' AutoEventWireup='true' CodeBehind='" + e.Name + "Edit.aspx.cs' Inherits='" + context.UserSpecifiedNamespace + "." + e.Name + "Edit' %>");
		...
		//public string GenerateEditDesignerCode(EntityDefinition e)
		//{
		//	var b = new StringBuilder();
		...
		//public string GenerateEditCodeBehindClass(EntityDefinition e)
		//{
		//	var b = new StringBuilder();
		...
		//	foreach (EntityDefinitionProperty p in definitionProperties)
		//	{
		//		if (p.IsPrimaryKey)
		//		{
		//			continue;
		...
		//private  string GenerateWebEditPresentationService(EntityDefinition e)
		//{
		...
		//private string GenerateMarkupForRelations(EntityDefinition e)
		//{
		...
		//private string GetMarkupForEdit(EntityDefinition e, EntityDefinitionProperty p)
		//{
		//	StringBuilder b = new StringBuilder();
		...
		//private string GenerateEmptyCheck(EntityDefinition e, EntityDefinitionProperty p)
		//{
		//	switch (p.PropertyType)
		//	{
		//		case DbType.Byte:
		...
		//private string GenerateConversionForReading(EntityDefinitionProperty e, ref bool hasConversion)
		//{
		...
		//private static string GenerateConversionFromNullableToDisplay(EntityDefinitionProperty p)
		//{
		//	switch (p.PropertyType)
		//	{
		//		case DbType.AnsiString:
